...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_DNArv_ProyectoF p_DNArv_ProyectoF;
        ...
        public static SteamVR_Input_ActionSet_DNArv_ProyectoF DNArv_ProyectoF
        {
            get
            {
                return SteamVR_Actions.p_DNArv_ProyectoF.GetCopy<SteamVR_Input_ActionSet_DNArv_ProyectoF>();
            }
        }
        ...
        {
            SteamVR_Actions.p_DNArv_ProyectoF = ((SteamVR_Input_ActionSet_DNArv_ProyectoF)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_DNArv_ProyectoF>("/actions/DNArv_ProyectoF")));
            ...
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions.DNArv_ProyectoF,
